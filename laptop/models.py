...
from libs.choices import PROD_TYPE_LAPTOP, PROD_BRAND_LAPTOP, PROD_SITUATION


class Laptop (models.Model):
    product_type = models.CharField(max_length=25,
                                    choices=PROD_TYPE_LAPTOP,
                                    verbose_name="Urunun Tipi")
    serial_number = models.CharField(max_length=50,
                                     verbose_name="Seri Numarasi")
    brand_name = models.CharField(max_length=25,
                                  choices=PROD_BRAND_LAPTOP,
    ...
    def save(self, *args, **kwargs):
        if not self.id:
            while True:
                ...
                if len(Laptop.objects.filter(survelliance_key=survelliance_key)) == 0:
