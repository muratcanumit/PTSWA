...
from libs.choices import PROD_TYPE_DESKTOP, PROD_SITUATION


class Desktop (models.Model):
    product_type = models.CharField(max_length=25,
                                    choices=PROD_TYPE_DESKTOP,
    ...
    def save(self, *args, **kwargs):
        if not self.id:
            while True:
                ...
                if len(Desktop.objects.filter(survelliance_key=survelliance_key)) == 0:
        ...
        super(Desktop, self).save(*args, **kwargs)
