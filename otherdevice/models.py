...
from libs.choices import PROD_TYPE_OTHER, PROD_SITUATION


class OtherDevice (models.Model):
    product_type = models.CharField(max_length=25,
                                    choices=PROD_TYPE_OTHER,
    ...
    def save(self, *args, **kwargs):
        if not self.id:
            while True:
                ...
                if len(OtherDevice.objects.filter(survelliance_key=survelliance_key)) == 0:
        ...
        super(OtherDevice, self).save(*args, **kwargs)
